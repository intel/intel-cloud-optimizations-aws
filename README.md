...
```
curl -X POST <loadbalancerdns>:8080/train -H 'Content-Type: application/json' -d '{"bucket":"icom-pilot-test1","backend":"s3","local_model_path":"None","data_key":"data","model_key":"model","model_name":"model.joblib","local_data_path":"None"}'
```
...
>>>>>>> e574cbcce71d966bbbc30ee97046aa0f282be45c
